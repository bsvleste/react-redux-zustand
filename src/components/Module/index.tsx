  ...
  return ( 
    ...
    <Collapsible.Trigger className="flex w-full items-center gap-3 bg-zinc-800 p-4">
      ...
      <div className="flex flex-col gap-1 text-left">
        ...
        <span className="text-xs">{amountOfLesson} aulas</span>
      </div>
      <ChevronDown className="w-4 h-4 ml-auto text-zinc-100 group-data-[state=open]:rotate-180 transition-transform" />
    </Collapsible.Trigger>
    <Collapsible.Content>
      <nav className='className="relative flex flex-col gap-4 p-6"'>
       { 
